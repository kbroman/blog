...
discussion about potential projects [in advance on GitHub](**insert
link**), and then the first morning we voted on what we were
interested in doing via stickers:
...
R package through which we can interactive with the game Minecraft.
