...
Slides for many of the talks and tutorials are on the [UseR 2014 web site](https://web.archive.org/web/20200130220813/http://user2014.r-project.org/). If you know of others, you can add them via the [site's GitHub repository](https://user2014.github.io) and make a pull request.
