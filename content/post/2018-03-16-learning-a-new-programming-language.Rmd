...
just wrote up resources pages (see [Intro to
...
think I want from that sort of langugage, so I'm sticking with Ruby
...
get by R alone, for data file manipulation.
...
my sloppiest C or C++ code. So to be fully self-sufficient, you want
...
[Pjotr Prins]() had me writing [D](https://dlang.org/) for a while,
...
There was also SQL and MongoDB in there. Data scientists need to be
at least comfortable with formal databases.
...
basics of the "purely functional programming" business, but I'll then
go back to PureScript.

## How to learn programming language

Anyway, that ws a bit too much of a blathery introduction to say: I
...
it (the learning) that might be useful.
...
is aimed at someone who can already program in something. But I think
it's mostly about the types of examples. Then after that writing style
...
and start using the language creatively to solve your own real
...
features and hacking away at something more substantial and _real_.
...
to keep them up-to-date. Because this stuff is tedious, painful, and
critical. You can find various of my notes on this stuff in my
[ProgrammingNotes
repository](https://github.com/kbroman/ProgrammingNotes) on GitHub.

But most importantly, you want something that you can quickly skim
through or search, because you'll forget stuff:

- How do define a function in this language?
- What do I use for comments?
- How do I concatenate two vectors?
- What was the syntax for list comprehensions again?

It's all in that book that you bought, but it's much easier to find in
a succinct set of notes that you wrote yourself. Here are some
...
And ultimately, you'll have four or five languages floating around in
your head and you'll not remember how to define a function in any of
them. And then you'll be really cool. Like me.
