...
Yesterday afternoon, they held a symposium on "Computation in Biology" ([Here's the agenda.](/images/computation-in-biology-agenda.pdf)) Great speakers: [Marc Suchard](https://suchard-group.github.io/), [Brian Shoichet](https://bkslab.org/), [David Page](https://medschool.duke.edu/profile/david-page), and [Winston Hide](https://hsci.harvard.edu/people/winston-hide-phd). They were asked to speak broadly about computation in biology and on the key issues for the future, and there was plenty of time for discussion.
