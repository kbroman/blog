...
experience](https://kbroman.wordpress.com/2014/08/12/if-i-could-do-it-over-again-id-self-publish/),
...
tutorials](http://kbroman.org/pages/tutorials) as bookdown books, I
wasn't in a hurry to do that.

But the R/minecraft team from the [ROpenSci](https://ropensci.org)
[Unconference](http://unconf17.ropensci.org) had such a great time
