...
[fst](https://www.fstpackage.org). And I thought I'd show a few
...
[Dirk Eddelbuettel](https://dirk.eddelbuettel.com/) suggested that I
look at the [fst package](https://www.fstpackage.org/). It's not quite
...
Doing queries on an [fst](https://www.fstpackage.org) file is not quite
...
with [fst](https://www.fstpackage.org) and slowed things down.
When accessing the data,
[feather](https://github.com/wesm/feather) was considerably faster
than [fst](https://www.fstpackage.org) when the data were organized
